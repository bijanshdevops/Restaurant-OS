        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16 items-center">
            ...
            <nav className="flex gap-2 overflow-x-auto whitespace-nowrap">
              ...
              {(hasRole('ADMIN') || hasRole('ACCOUNTANT')) && (
                <Link href="/dashboard/accounting/cash-flow" className="text-gray-600 hover:text-blue-600 px-3 py-2 rounded-md text-sm font-medium transition-colors">جریان نقدی</Link>
              )}
